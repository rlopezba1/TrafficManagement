...
public final class Service3Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.service3.infoString,
      grpc.service3.infoString> getSendClientStreamingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendClientStreaming",
      requestType = grpc.service3.infoString.class,
      responseType = grpc.service3.infoString.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.service3.infoString,
      grpc.service3.infoString> getSendClientStreamingMethod() {
    io.grpc.MethodDescriptor<grpc.service3.infoString, grpc.service3.infoString> getSendClientStreamingMethod;
    if ((getSendClientStreamingMethod = Service3Grpc.getSendClientStreamingMethod) == null) {
      synchronized (Service3Grpc.class) {
        if ((getSendClientStreamingMethod = Service3Grpc.getSendClientStreamingMethod) == null) {
          Service3Grpc.getSendClientStreamingMethod = getSendClientStreamingMethod = 
              io.grpc.MethodDescriptor.<grpc.service3.infoString, grpc.service3.infoString>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Service3", "SendClientStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.service3.infoString.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.service3.infoString.getDefaultInstance()))
                  .setSchemaDescriptor(new Service3MethodDescriptorSupplier("SendClientStreaming"))
                  .build();
          }
        }
     }
     return getSendClientStreamingMethod;
  }
  ...
  public static abstract class Service3ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<grpc.service3.infoString> sendClientStreaming(
        io.grpc.stub.StreamObserver<grpc.service3.infoString> responseObserver) {
      return asyncUnimplementedStreamingCall(getSendClientStreamingMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getSendClientStreamingMethod(),
            asyncClientStreamingCall(
              new MethodHandlers<
                grpc.service3.infoString,
                grpc.service3.infoString>(
                  this, METHODID_SEND_CLIENT_STREAMING)))
          .build();
    }
  }
  ...
  public static final class Service3Stub extends io.grpc.stub.AbstractStub<Service3Stub> {
    ...
    public io.grpc.stub.StreamObserver<grpc.service3.infoString> sendClientStreaming(
      ...
      return asyncClientStreamingCall(
          getChannel().newCall(getSendClientStreamingMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_SEND_CLIENT_STREAMING = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_SEND_CLIENT_STREAMING:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.sendClientStreaming(
              (io.grpc.stub.StreamObserver<grpc.service3.infoString>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static abstract class Service3BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.service3.Service3Impl.getDescriptor();
    }
      ...
      synchronized (Service3Grpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSendClientStreamingMethod())
              .build();
        }
      }
    }
